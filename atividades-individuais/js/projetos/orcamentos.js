document.querySelector('.seu-nome').textContent = "Vinicius Cruz";
const PRECO_PRO_PAGINA = 500;
const PRECO_DESIGN_ADICIONAL = 1000;

const inputPaginas = document.querySelector ("#qtde-paginas");
